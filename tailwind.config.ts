...
        extend: {
            fontFamily: {
                'morganite': ['Orbitron', 'sans-serif'], // Usando Orbitron como substituto de Morganite
                'sora': ['Sora', 'sans-serif'],
                'sans': ['Sora', 'system-ui', 'sans-serif'], // Definindo Sora como padrão
            },
            colors: {
                // Cores da marca A Chave
...
                'achave-purple': 'hsl(var(--achave-purple))', // <-- ADICIONADO AQUI
